...
/**
 * Schema applied on every startup. Safe to run repeatedly (IF NOT EXISTS).
 *
 * The shape here must stay byte-identical to the Drizzle schema in
 * `./schema.ts` so files created before v2 continue to work.
 */
